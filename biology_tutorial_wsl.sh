...
if [ ${#files[@]} -eq 0 ]; then
    ...
    if [[ -z "$user_input" ]]; then
        ...
        curl -O -L https://github.com/Muhumuza7325/OMD/raw/main/1.1.introduction_to_biology.txt || echo -e "\n\nError fetching material for this tutorial \c"
    ...
    rm -f ../biology_tutorial 1.1.introduction_to_biology.txt
fi
