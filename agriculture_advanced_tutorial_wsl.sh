          ...
          case "$topic" in
            ...
            5)
              ...
              if ! [ -f ".s_agriculture_advanced_6_5" ]; then
                echo -e "\n\nHere you are dear one... Stay organised as you explore Crop and crop product scoreeting ...\n\n${g}Just know we are not going to leave you alone${t}\n\nWe promise to always be right here for you \c" && wait_for_a_key_press
              fi
