    ...
    if [[ -n "$user_input" ]]; then
        ...
        if [[ "$user_input" == "xx" ]]; then
            ...
            if [[ "$input" == "y" || "$input" == "Y" ]]; then
                ...
                curl -O -L "https://github.com/Muhumuza7325/Muhumuza7325/raw/main/update_ire.sh" || { echo -e "\n\n${m}Check your internet connection and try again!${t}" >&2; return; }
...
if [ ${#files[@]} -eq 0 ]; then
    ...
    rm -f ../ire_tutorial 1.1.worship.txt
fi
